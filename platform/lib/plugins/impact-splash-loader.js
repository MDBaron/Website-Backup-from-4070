...
ig.ImpactSplashLoader = ig.Loader.extend({
	...
	run: function() {	
		...
		ig.system.context.fillStyle = 'rgba(87,115,48,'+alpha+')';
	...
	draw: function() {
		...
		// URL
		ctx.fillStyle = 'rgb(178,118,158)';
		ctx.textAlign = 'right';
		ctx.font = '10px Arial';
		ctx.fillText( 'http://recursivetoasteroven.elementfx.com/', w - 10, h - 10 );
		ctx.textAlign = 'left';
