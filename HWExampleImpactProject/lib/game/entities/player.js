...
.defines(function(){
    EntityPlayer = ig.Entity.extend({
		...
		moduleNear: function(){
			var distance = (this.x - this.moduleX) + (this.y - this.moduleY);
			if(distance < 15){
				return true;
			} else {
				return false;
        ...
        update: function() {
			...
			if(ig.input.pressed('pickup')){
				...
				if(true/*this.holdingAuxWeapon == 0 && this.moduleNear()*/){
					//pickup weapon module
					this.totalWeapons++;
				}
				if(/*this.holdingAuxWeapon == 1*/true){
					this.totalWeapons--;
					//drop weapon module
				}
			}
            ...
            if( ig.input.pressed('switch') ) {
                ...
                switch(this.weapon){
                	...
                	case(1):
						...
						break;
					case(2):
						this.activeWeapon = "EntityPlasma";
						break;
                }
                this.setupAnimation(this.weapon);
            }
    ...
    EntityBullet = ig.Entity.extend({
        ...
        handleMovementTrace: function( res ) {
        	...
        	if( res.collision.x || res.collision.y ) {
				...
				this.bounciness = this.bounciness - (1);
        	}
        },
        check: function( other ) {
	...
	EntityWeaponModule = ig.Entity.extend({
        size: {x: 1, y: 1},
        animSheet: new ig.AnimationSheet( 'media/EBspritesheet.png', 886, 689 ),
        maxVel: {x: 10, y: 10},
		bounciness: 0.1,
        type: ig.Entity.TYPE.NONE,
        checkAgainst: ig.Entity.TYPE.B,
	...
	*/
    ...
    EntityDeathExplosionParticle = ig.Entity.extend({
        ...
        colorOffset: 0,
        totalColors: 7,
        animSheet: new ig.AnimationSheet( 'media/life-sprite.png', 1, 1 ),
        init: function( x, y, settings ) {
            this.parent( x, y, settings );
